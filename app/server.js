...
//CLIENT EVENTS
client.on("ready", () => {
  console.log('Sunt gata :D | Bot created by Sanke')
  client.user.setActivity("comenzi | Bobi")
})
...
client.on("message", message => {
  ...
  try  { //TRY TO GET COMMAND AND EXECUTE
    ...
    console.log(`${message.guild.name}: ${message.author.tag} Used ${client.commands.get(command).name} in #${message.channel.name}`)
      ...
      console.log(err)
      message.reply("Am o mica eroare,viziteaza ,,logs'' pentru mai multe informatii.")
    }
